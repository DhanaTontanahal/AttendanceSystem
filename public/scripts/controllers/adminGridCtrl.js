...
$scope.editOrUpdateTheUserCategorySelected = ["Initiated", "Jigyasu" , "Children below 18"];
...
// return;
	var postData = {
    regionName:$scope.editOrUpdateTheUserregionName,
    branchName:$scope.editOrUpdateTheUserbranchName,
    districtName:$scope.editOrUpdateTheUserdistrictName,
...
$scope.saveRow = function(rowEntity){
 ...
 { name:'edit', enableCellEdit: false,width:110, cellTemplate:'<div>' +
  ...
  { name:'SatsangiName', enableCellEdit: false,headerCellClass: 'blue',field: 'nameSatsangi',enableFiltering: true,enableHiding:false  }, 
...
{ name:'Region', enableCellEdit: false,field: 'regionName',headerCellClass: 'blue',enableFiltering: false,enableHiding:false },
 ...
 $scope.columns1 = [
  ...
  { name:'Satsangi name',  visible:true,headerCellClass: 'blue',field: 'nameSatsangi' ,enableFiltering: true } 

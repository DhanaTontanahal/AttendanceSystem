...
define(['./module'], function (controllers) {
    'use strict';
    controllers.controller('WcsummaryDataCtrl',['$firebaseObject','$q','$location','$firebaseArray','$filter','uiGridExporterService', 'uiGridExporterConstants','AuthService','$rootScope', '$scope','$http','$log','$timeout',
...
$scope.namesOfActivity = ["Weekly Cleaning"];
$scope.messagesData = [];
  ...
  { name:'Weekly Cleaning', visible:true, headerCellClass: 'blue', field: 'countVallueE-Satsang',enableFiltering: true },

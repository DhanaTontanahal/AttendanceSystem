define(['./module'], function (controllers) {
    'use strict';
    controllers.controller('WwusummaryDataCtrl',['$firebaseObject','$q','$location','$firebaseArray','$filter','uiGridExporterService', 'uiGridExporterConstants','AuthService','$rootScope', '$scope','$http','$log','$timeout',
...
$scope.messagesData = [];
  ...
  { name:'Windup', visible:true, headerCellClass: 'blue', field: 'countVallueE-Satsang',enableFiltering: true },
